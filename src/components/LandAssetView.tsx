...
export const LandAssetView: React.FC<LandAssetViewProps> = ({ onSelectTab }) => {
  return (
    <div className="space-y-0 text-[#1E4334]">
      ...
      {/* Big Flow: 토지 → 식물 → 관리 → 자산 */}
      <section className="bg-white py-14 border-b border-[#1E4334]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <span className="text-xs font-semibold text-[#5E856F] tracking-widest uppercase">
              SAFE GARDEN CORE CYCLE
            </span>
            <h2 className="text-xl sm:text-2xl font-bold text-[#1E4334] mt-1">
              토지의 가능성을 자산의 가치로
            </h2>
          </div>
            ...
            {[
              {
                step: '01',
                title: '토지 (Land)',
                desc: '위치·접근성, 토양·배수·일조 환경 분석 및 진단',
              },
              {
                step: '02',
                title: '식물 (Plant)',
                desc: '환경 맞춤 수종·작물 매칭 및 생육계획 수립',
              },
              {
                step: '03',
                title: '관리 (Care)',
                desc: '정기 생육 예찰, 예초·전정·시비 및 주변 환경 관리',
              },
              {
                step: '04',
                title: '자산 (Asset)',
                desc: '식물자산 가치 관리, 수확·판매·이식 및 지속 기록',
              },
            ].map((st, i) => (
              <div
                key={i}
                className="p-5 rounded-xl bg-[#FAF8F5] border border-[#1E4334]/10 text-center space-y-1.5"
              >
                <span className="text-[11px] font-mono font-bold text-[#5E856F]">{st.step}</span>
                <h3 className="text-base sm:text-lg font-bold text-[#1E4334]">{st.title}</h3>
                <p className="text-xs text-[#1E4334]/70">{st.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#FAF8F5] py-20 lg:py-28 border-b border-[#1E4334]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
          ...
          <div className="max-w-2xl space-y-2">
            ...
            <p className="text-sm sm:text-base text-[#1E4334]/70">
              세이프가든은 현장에 직접 가서 눈으로 보고 손으로 흙을 만져보며 필요한 서비스를 판단합니다.
            </p>
          </div>

          {/* Service 01: 접근성 조사 */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white rounded-2xl p-6 sm:p-10 border border-[#1E4334]/10 shadow-xs">
            <div className="lg:col-span-6 space-y-5">
              <div className="flex items-center space-x-2">
                <span className="px-3 py-1 bg-[#1E4334] text-white text-xs font-mono font-bold rounded">
                  01
                </span>
                <span className="text-xs font-bold text-[#5E856F] tracking-wider uppercase">
              ...
              <blockquote className="border-l-2 border-[#5E856F] pl-4 italic text-sm text-[#1E4334]/90 font-medium">
                "진입도로, 농로, 차량 접근성, 작업공간과 향후 운반 가능성까지 확인합니다."
              </blockquote>

              <p className="text-sm text-[#1E4334]/80 leading-relaxed">
              ...
              <div className="space-y-2 pt-2">
                <span className="text-xs font-bold text-[#1E4334] block">주요 현장 조사 항목:</span>
                <ul className="space-y-1.5 text-xs text-[#1E4334]/85">
            ...
            <div className="lg:col-span-6">
              <div className="rounded-xl overflow-hidden border border-[#1E4334]/15 shadow-sm">
                <img
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center bg-white rounded-2xl p-6 sm:p-10 border border-[#1E4334]/10 shadow-xs">
            <div className="lg:col-span-6 order-2 lg:order-1">
              <div className="rounded-xl overflow-hidden border border-[#1E4334]/15 shadow-sm bg-[#EFECE3]">
                <img
                  src={IMAGES.soilLand}
      ...
      <section className="bg-white py-20 border-b border-[#1E4334]/10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
            ...
            <p className="text-xs sm:text-sm text-[#1E4334]/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* 일반 조경업체 */}
            <div className="p-6 rounded-xl bg-[#FAF8F5]/50 border border-[#1E4334]/10 space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#1E4334]/10">
                <span className="font-bold text-base text-[#1E4334]/70">일반 조경업체</span>
                <span className="text-xs bg-[#1E4334]/10 px-2.5 py-1 rounded text-[#1E4334]/70 font-medium">공간 미화 중심</span>
              </div>
              <ul className="space-y-2.5 text-xs text-[#1E4334]/70">
            ...
            {/* 세이프가든 */}
            <div className="p-6 rounded-xl bg-[#1E4334] text-[#FAF8F5] border border-[#1E4334] space-y-4 shadow-sm">
              <div className="flex items-center justify-between pb-3 border-b border-white/10">
                <span className="font-bold text-base text-white">세이프가든 (Safe Garden)</span>
                <span className="text-xs bg-[#5E856F] text-[#1E4334] px-2.5 py-1 rounded font-bold">현장 자산 관리</span>
              </div>
              <ul className="space-y-2.5 text-xs text-[#FAF8F5]/90">
                <li className="flex items-start space-x-2">
                  <CheckCircle2 className="w-4 h-4 text-[#5E856F] shrink-0 mt-0.5" />
      ...
      <section className="bg-[#FAF8F5] py-16 text-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <p className="text-sm text-[#1E4334]/75">
            토지 지번이나 위치를 알려주시면 진입 도로와 생육 여건을 사전 검토한 후 현장 일정 상담을 안내해 드립니다.
          </p>
          <div>
            <button
              onClick={() => onSelectTab('consultation')}
              className="inline-flex items-center space-x-2 px-7 py-3.5 bg-[#1E4334] hover:bg-[#255240] text-[#FAF8F5] font-semibold text-sm rounded-lg shadow-sm"
            >
